...
class ListLend extends StatelessWidget {
  @override
...
class ListLendPage extends StatefulWidget {
  ListLendPage();

  @override
  _ListLendPageState createState() => _ListLendPageState();
}

class _ListLendPageState extends State<ListLendPage> {
                                  ...
                                  children: <Widget>[
                                    ...
                                    item["status"]==2?Container(
                                      ...
                                      child: IconButton(
                                          ...
                                          onPressed: () {
                                            deletedialog("", "Are you sure want to delete this Lending Details?", true,
  ...
  Future deleteItem(item) async {
    ...
    DBHelper().deleteLendItemIncome(item["id"]);
    // To close the dialog
    getAllLendList();
  }

  Future getAllLendList() async {
    var list = await DBHelper().getAllLenderList();
    print(list.toString());
  ...
  getSearchItems(status) async{
    var list = await DBHelper().getLenderStatusList(status);
    print(list.toString());
    await new Future.delayed(const Duration(seconds: 1));
    setState(() {
      borrowItemList.clear();
